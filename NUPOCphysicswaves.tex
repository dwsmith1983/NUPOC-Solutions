...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 1.25in, mode = image]{tikz/NUPOCphysicswaves2}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 2.5in, mode = image]{tikz/NUPOCphysicswaves9}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 2in, mode = image]{tikz/NUPOCphysicswaves10}
...
\item
  ...
  \begin{figure}[H]
    ...
    \subcaptionbox{Convex lens\label{convex}}{
      \includestandalone[height = 2in, mode = image]{tikz/NUPOCphysicswaves11}}
    \qquad
    \subcaptionbox{Concave lens\label{concave}}{
      \includestandalone[height = 2in, mode = image]
      {tikz/NUPOCphysicswaves11b}}
