...
\item
  ...
  \begin{figure}[H]
    ...
    \subcaptionbox{What is giving}{
      \includestandalone[mode = image, width = 2in]{NUPOCphysics1}}
    \qquad
    \subcaptionbox{Forces drawn\label{solforce}}{
      \includestandalone[mode = image, width = 2in]{NUPOCphysics1sol}}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, width = 3in]{NUPOCphysics2}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, height = 1.5in]{NUPOCphysics3}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, width = 1.5in]{NUPOCphysics5}
...
\item
  ...
  \begin{figure}[H]
    ...
    \subcaptionbox{Prior to being released\label{notreleased}}{
      \includestandalone[mode = image, height = .75in]{NUPOCphysics7}}
    \quad
    \subcaptionbox{At the apex of the loop.\label{apexloop}}{
      \includestandalone[mode = image, width = 1in]{NUPOCphysics7loop}}
...
\item
  ...
  \begin{figure}[H]
    ...
    \subcaptionbox{The flight path of a projectile.}{
      \includestandalone[mode = image, width = 2.5in]{NUPOCphysics8}}
    \qquad
    \subcaptionbox{Components of the velocity vector.}{
      \includestandalone[mode = image, height = 1in]{NUPOCphysics8v}}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, width = 2.5in]{NUPOCphysics10}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, width = 2.5in]{NUPOCphysics11}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, width = 2.5in]{NUPOCphysics12}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, height = 2in]{NUPOCphysics13}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, height = 1.5in]{NUPOCphysics14}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, width = 2in]{NUPOCphysics15}
    \caption{Rocket sled}
  \end{figure}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[mode = image, height = 1.75in]{NUPOCphysics16}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 1.75in, mode = image]{NUPOCphysics18}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 1in, mode = image]{NUPOCphysics19}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 0.5in, mode = image]{NUPOCphysics20}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 1in, mode = image]{NUPOCphysics22}
...
\item
  ...
  \begin{figure}[H]
    \centering
    \includestandalone[height = 1.25in, mode = image]{NUPOCphysics24}
